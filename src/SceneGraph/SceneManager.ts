...
export class SceneManager<C extends bjs.Camera> 
{
    ...
    public LoadScene(scene: Scene<C>, canvas : HTMLCanvasElement, position : ViewportPosition, callback?: Function)
    {
        Logger.log("SceneManager : Loading Scene")
        if ( this.scenes.length === 0)
        {
            this.engine = new bjs.Engine(canvas as HTMLCanvasElement,true,undefined,false);
        }
        ...
        if (this.engine) {
            ...
            scene.load(this.engine, callback);
        }
