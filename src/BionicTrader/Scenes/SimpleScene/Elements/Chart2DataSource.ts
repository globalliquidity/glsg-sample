...
export class Chart2DDataSource extends ActiveModel<Chart2DPresenter>
{
    ...
    private async refreshPresenter()
    {
        ...
        if (this.data != null)
        {
            // console.log("Chart2D: Got Data - Updating Presenter");
            this.presenter.updatePresenter(this.data);
        }
        else
        {
            console.log("Chart2D: Didnt Get Data");
        }
    }
    ...
    private async buildChart()
    {
        ...
        if (chart != null)
        {
            ...
            this.data = new Chart2DUpdateMessage(chartCanvas);
            this.presenter.updatePresenter(this.data);
        }
        else
        {
