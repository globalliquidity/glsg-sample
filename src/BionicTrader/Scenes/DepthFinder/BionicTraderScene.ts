...
import { wavDowntick, wavUptick } from '../../../../global/Assets';
...
export class BionicTraderScene extends StandardScene implements IMessageBusClient {
    ...
    */
    ...
    assetsPath: Array<Object> = [
        ...
        {type: 'mesh', name:'bidblock', url: '/', fileName: 'simplecube.babylon'},
        {type: 'mesh', name:'askblock', url: '/', fileName: 'simplecube.babylon'},
        ...
        {type: 'mesh', name:'frame', url: '/', fileName: 'frame.glb'}
