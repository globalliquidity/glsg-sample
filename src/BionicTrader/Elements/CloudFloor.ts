...
import { generateWaterMaterial } from '../Utils';
import { pngCloud, } from '../../../global/Assets';
...
export class CloudFloor extends SceneElement
{
    ...
    async create()
    {
        ...
        */
        ...
        this.cloudMaterial.setTexture("textureSampler", new bjs.Texture(pngCloud, this.scene.bjsScene));
